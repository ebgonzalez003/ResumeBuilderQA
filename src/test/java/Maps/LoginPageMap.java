...
public class LoginPageMap {
    ...
    // Login Section
    public By loginPageUserEmail = By.id("email");
    public By loginPagePassword = By.id("password");
    ...
    // Ticket Section
    public By emailTicketTxtBx = By.id("user-email");
    public By nextTicketBtn = By.xpath("//*[@id='login-button']/span");
    public By pwdTicketTxtBx = By.xpath("//*[@id='root']/div[3]/div/div/div/div/div[2]/main/div/div/div/div[1]");
